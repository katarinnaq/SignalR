...
namespace ProjekatSignalR.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            else if (user.Prezime != Input.Prezime)
            {
            ...
            else if (user.KorisnickoIme != Input.KorisnickoIme)
            {
            ...
            StatusMessage = "Podaci su azurirani!";
            return RedirectToPage();
        }
    }
}
